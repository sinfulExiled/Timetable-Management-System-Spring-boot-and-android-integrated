...
public class TeacherTimetable extends AppCompatActivity implements ClassesAdapter.ClickedItem {
    ...
    Boolean mIsSpinner2FirstCall = true;
...
//        spinner.setPrompt("Select Class");
        ...
        spinner2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(!mIsSpinner2FirstCall) {
                    String s2 = spinner2.getSelectedItem().toString();

                    System.out.println(s2);
                    getClassesforTeacher(s2);
                }
                mIsSpinner2FirstCall = false;
        ...
        startET.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    ...
                    DatePickerDialog dialog = new DatePickerDialog(TeacherTimetable.this, android.R.style.Theme_Holo_Dialog_MinWidth,
                            mDatesetListener,
                            year, month, day);
        ...
        endET.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    ...
                    DatePickerDialog dialog2 = new DatePickerDialog(TeacherTimetable.this, android.R.style.Theme_Holo_Dialog_MinWidth,
                            mDatesetListener2,
                            year, month, day);
    ...
    public void getClassesforBatch(String Callbatch) {
        ...
        pDialog2 = new ProgressDialog(TeacherTimetable.this);
    ...
    public void getClassesforTeacher(String Callbatch) {
    ...
    public List<String> getAllClasses(String fromDay, String toDay, int allcall, String Callbatch) {
        ...
        pDialog = new ProgressDialog(TeacherTimetable.this);
    ...
    public void getSelectedUser(View v) {
        String cla = (String) spinner.getSelectedItem();
        displayUserData(cla);
    }
